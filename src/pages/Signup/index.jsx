...
const validationSchema = yup.object().shape({
  ...
  username: yup.string().required('Prencha seu usuario'),
  email: yup.string().email('Informe um e-mail válido').required('Prencha seu e-mail'),
  password: yup.string().required('Prencha sua senha')
})
...
export const Signup = () => {
  ...
  // console.log(formik.errors) erro no console
